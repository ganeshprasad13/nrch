...
if(request.getServerName().equals("iricen.indianrailways.gov.in") || request.getServerName().equals("iricen.indianrailways.gov.in")){
	DBname = "cris-iriceen"; 
	Hname ="iricen";
...
<% String JDBC_URL =  "jdbc:mysql://10.64.24.67:3306/"+DBname+"?user="+DBUserName+"&password="+DBUserPwd+"&useUnicode=true&characterEncoding=UTF8";  %>
...
String newurl1 = "" ; 
 ...
 newurl = "http://"+Hname+".indianrailways.gov.in/" ; 
 strAppPath = "http://"+Hname+".indianrailways.gov.in/instt/";
 strWebAppURL = "http://"+Hname+".indianrailways.gov.in/";
