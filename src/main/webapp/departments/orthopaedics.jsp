  ...
  <div class="card-overview w-100">
    ...
    <div id="ntext">
      ...
      <div class="text-end mt-3">
        <a href="#" class="linkn"><img src="images/top.gif" height="10" alt="Top"></a><br>
        <span class="font_12px" style="font-family:tahoma;color:black">
          <b>Source :</b> Northern Railways / Indian Railways Portal CMS Team Last Reviewed : 27-10-2025 &nbsp;<img src="images/sourceiconw.gif" alt="Source Icon">
        </span>
      </div>
    </div>
  </div>
