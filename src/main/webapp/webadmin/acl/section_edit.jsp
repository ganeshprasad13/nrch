...
query_level = query_level + " WHERE DSM_ID in (?) AND DSM_ID = DLC_DSM_ID AND DLC_LANG_ID =0";
...
<form name="RTEDemo" action="section_edit_action.jsp" method="post" onsubmit="javascript:return chkform()">
	...
	<input type="hidden" name="id1" value="<%=dbBean.getcell(getinfo,11,1)%>">
...
<tr>
	...
	<td width="50%">
	<input type=text size="50" name="label1" value="<%=dbBean.getcell(getinfo,1,1)%>"></td>
</tr>
<tr>
...
<tr>
	...
	<font class="tab" id="fnEnglish"><a style="color:red;" href="javascript:showRTF(1);" class="tablink">English</a></font>&nbsp;&nbsp;<font  id="fnHindi" class="tab"><a style="color:red;"  href="javascript:showRTF(2);" class="tablink">&#2361;&#2367;&#2344;&#2381;&#2342;&#2368;</a></font>
	</td>
</tr>
<tr>
	<td colspan="2" align="center"><%
...
<%		if(strLanguageOption.equals("1") || strLanguageOption.equals("2")){
	// out.println("strLanguageOption =======================     "+strLanguageOption);
	 %>
			...
			<textarea name=description0 rows=40 cols=50><%=str0%></textarea>
			</td>
			</tr></table>
<%		}%>
	</div>	
...
String str1 = dbBean.getcell(getinfo,3,1);
//str1 = str1.replaceAll("\"","").replaceAll("\n","").replaceAll("\r","");
%>
	<div id="rtf2" style="display:none">
<%	if(strLanguageOption.equals("1") || strLanguageOption.equals("3")){%>
		<table style="font-size:12px;">
			<tr>
				<td align="center"><b>Description in &#2361;&#2367;&#2344;&#2381;&#2342;&#2368;&nbsp;&nbsp;&nbsp;<a href="#" onClick="MyWindow=window.open('hindi.jsp','MyWindow','toolbar=no,location=no,directories=no,status=no, menubar=no,scrollbars=no,resizable=yes,width=800,height=600'); return false;"><font color=blue>Hindi Keyboard</font></a></b><br>
					<!--Select KeyBoard&nbsp;&nbsp;<script type="text/javascript">loadKeyboardLayouts();</script><br>-->
					<textarea class="LblHAnswer" name="description1" rows="40" cols="50" ><%=str1%></textarea>
				</td>
			</tr>
		</table>
<%	}%>		
