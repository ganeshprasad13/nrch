...
updateinfo = "update CMS_DIRECT_CONTENT set DDC_LABEL=N'"+ label0 +"',DDC_RIGHT="+ strRight +", DDC_DESCRIPTION=N'"+ description0 +"', DDC_START_DATE='"+ syear + "-" + smon + "-" + sday +"', DDC_END_DATE = '"+ eyear + "-" + emon + "-" + eday +"', DDC_ADDTO_TICKER="+ addtoticker +", DDC_MODIFIED_BY='"+ session.getAttribute("DBAusername") +"',DDC_MODIFIED_DATE=now(),DDC_TENDERNO='"+DDC_TENDERNO+"',DDC_DIVISIONS_ID="+DDC_DIVISIONS_ID+",DDC_DEPARTMENTS_ID="+DDC_DEPARTMENTS_ID+",DDC_OFFICER_ID='"+pubOfficerId+"',DDC_PRESS_CITY='"+pubCity+"',DDC_PRESS_NEWS_NO='"+pubNewsNo+"'  where DDC_LANG_ID=0 and DDC_IDENTIFIER = '" + refid + "'";
...
//updateinfo = "INSERT INTO CMS_DIRECT_CONTENT (DDC_DSM_ID, DDC_LANG_ID, DDC_LABEL,DDC_RIGHT, DDC_DESCRIPTION, DDC_START_DATE, DDC_END_DATE, DDC_CREATED_BY,DDC_ADDTO_TICKER,DDC_IDENTIFIER) VALUES ("+id+",1,N'"+label1+"',"+strRight+",N'"+description1+"','"+syear+"-"+smon+"-"+sday+"','"+eyear+"-"+emon+"-"+eday+"','"+session.getAttribute("DBAusername")+"',"+addtoticker+",'"+strTime+"')";
updateinfo = "update CMS_DIRECT_CONTENT set DDC_LABEL=N'"+ label1 +"',DDC_RIGHT="+ strRight +", DDC_DESCRIPTION=N'"+ description1 +"', DDC_START_DATE='"+ syear + "-" + smon + "-" + sday +"', DDC_END_DATE = '"+ eyear + "-" + emon + "-" + eday +"', DDC_ADDTO_TICKER="+ addtoticker +", DDC_MODIFIED_BY='"+ session.getAttribute("DBAusername") +"',DDC_MODIFIED_DATE=now(),DDC_OFFICER_ID='"+pubOfficerId+"',DDC_PRESS_CITY='"+pubCity+"',DDC_PRESS_NEWS_NO='"+pubNewsNo+"'  where DDC_LANG_ID=1 and DDC_IDENTIFIER = '" + refid + "'";
