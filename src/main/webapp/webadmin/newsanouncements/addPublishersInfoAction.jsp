...
try {
	String strPubInfo = "";
		strPubInfo = "INSERT INTO CMS_PRESS_PUBLISHER_INFO(PUB_NAME, PUB_DESIGNATION, PUB_SIGNATURE,PUB_CREATED_ON,PUB_CREATED_BY, STATUS) ";
		strPubInfo+=" VALUES('"+pubName+"','"+pubDesignation+"','"+fFileName[0]+"',NOW(),'"+User+"','Active')";
		dbBean.setQuery(strPubInfo);
		dbBean.go1();
	
	String actype = "0";
	String acmsg = "AddNewPublisherInfo";
	String acdescription =  session.getAttribute("DBAUserId") + " login for add New Publisher information ";
