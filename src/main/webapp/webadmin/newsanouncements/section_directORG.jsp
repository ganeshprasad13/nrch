...
%>
<a href="section_management.jsp?parent=<%=dbBean.getcell(getlevel,0,i)%>&path=<%=dbBean.getcell(getlevel,2,i)%>" class="link" style="font-size:14px;font-family:tahoma;"><%=dbBean.getcell(getlevel,1,i)%></a>
<% 
	}
	}
%>
