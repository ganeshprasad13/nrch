...
var oform=parent
var fidx=0;while(document.forms[fidx]!=oform)fidx++//formindex
...
<img src='IURL/toolbar.start.gif' title='Left' class=vdevSep>\
...
<img src='IURL/toolbar.separator.gif' title='Seperator' class=vdevSep>\
...
<img src='IURL/toolbar.separator.gif' title='Left' class=vdevSep>\
...
<TD nowrap style='cursor:pointer'>\
<SELECT name='QBCNTRL1' title='FontName' class=vdev onchange='doFormatF(\"FontName,\"+this.value)' style='width:90'>\
...
"<OPTION value='"+M_FONT6+"' style='font-family:"+M_FONT6+"'>"+M_FONT6T+
"</SELECT>\
<SELECT name='QBCNTRL2' title='Headline' class=vdev onchange='doFormatF(\"formatBlock,\"+this.value)' style='width:60'>\
<OPTION value=''>"+M_HEAD+
"<OPTION value='H1'>H1\
<OPTION value='H2'>H2\
<OPTION value='H3'>H3\
...
<SELECT name='QBCNTRL3' title='FontSize' class=vdev onchange='doFormatF(\"FontSize,\"+this.value)' style='width:50'>\
...
str+="\
<INPUT name='QBCNTRL5' title='View/Source' value='"+M_SWAPMODE+"' class='vdev' onclick='swapMode()' type=button>\
<INPUT name='QBCNTRL8' title='Upload files' value='"+M_UPLOAD+"' class='vdev' onclick='doUploadFile(\"file\")' type=button>\
"
/*
if(UNICODE)str+="\
...
{
/*str+="\
<INPUT name='QBCNTRL7' title='View/Iso' value='"+M_SWAPCODE+"' class=vdev onclick='swapCharCode()' type=button>\
"
...
var nW=window.open(urlx,"destroy","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,menubar=no,top="+tposy+",left="+tposx)
nW.moveTo(tposx,tposy)
nW.focus()
}
...
function doUploadFile(arr)
{
var el=clickE()
if(!el)return
el.focus()
var urlx=QBPATH+'/uploadInit.jsp?type='+arr
var twidth=0.8*screen.width,theight=140
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"upload","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"options","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"extras","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"divborder","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"divfilter","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
if(rng.findText(FWORD,100000,FLAGS+forward)==true){rng.select();rng.scrollIntoView();return}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"fdialog","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var sArr=tstyle.split(",")// ontName,ForeColor,HiliteColor,FontSize,Italic
...
{
	insertImageToOpener(cmd[1])
}
else if(cmd[0]=='InsertImage'&&!cmd[1])
{
	insertImage()
}
else if(cmd[0]=='InsertFileAsLink'&&cmd[1])
{
	createLink(cmd[1])
}
else if(cmd[1]!=null)
...
function insertImageToOpener(imgName)
{
	var el=clickE()
	if(!el)return
	var urlx=QBPATH+'/insertimage.html?img='+imgName
	var twidth=500
	var theight=170
	var tposx=(screen.width-twidth)/2
	var tposy=(screen.height-theight)/2
	var nW=window.open(urlx,"format","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,menubar=no,top="+tposy+",left="+tposx)
	nW.moveTo(tposx,tposy)
	nW.focus()
}
...
else strx=el.document.body.innerText
...
else
{
 ...
 for(var i=0;i<tdA.length;i++){tdA[i].attachEvent("onclick",clickTD)}
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"divstyle","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
var feature="font-family:Arial;font-size:10pt;dialogWidth:30em;dialogHeight:27em;dialogTop:"+y+";edge:sunken;help:no;status:no"
...
if(!el)return
el.focus()
var urlx=QBPATH+'/createlink.jsp?fileURL='+arg
var arr=showModalDialog(urlx,el,"font-family:Verdana;font-size:12;dialogWidth:50em;dialogHeight:35em;edge:sunken;help:no;status:no")
//var twidth=350,theight=150
//var tpx=(screen.width-twidth)/2
//var tpy=(screen.height-theight)/2
//var nW=window.open(urlx,"fm","toolbar=no,top="+tpy+",left="+ tpx +",width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,menubar=no")
//nW.moveTo(tpx,tpy)
//nW.focus()
}
...
var tposx=(screen.width-twidth)/2
var tposy=(screen.height-theight)/2
var nW=window.open(urlx,"format","toolbar=no,width="+twidth+",height="+theight+",directories=no,status=no,scrollbars=yes,resizable=no,top="+tposy+",left="+tposx+",menubar=no")
nW.moveTo(tposx,tposy)
nW.focus()
}
...
if(cmd!='InsertImage'&&!arr)doFormatF('RemoveFormat')
else if(arr)doFormatF(cmd+','+arr)
}
