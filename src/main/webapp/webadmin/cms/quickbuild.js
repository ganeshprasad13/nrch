...
if(typeof(DFFACE)=="undefined") DFFACE='Arial'; // 'times new roman'; // Default fontFamily of Editor
if(typeof(DFSIZE)=="undefined") DFSIZE='12px'; // '14px'; // Default fontSize
if(typeof(DCOLOR)=="undefined") DCOLOR='black'; // 'blue'; // Default color
if(typeof(DBGCOL)=="undefined") DBGCOL='white'; // 'green'; // Default backgroundColor
...
if(typeof(USEFORM)=="undefined") USEFORM=1; // Enable form input
...
if(typeof(NOLOCURL)=='undefined') NOLOCURL=0; // enable local url "file:///"
/*********************** END CONFIGURATION ****************************/
