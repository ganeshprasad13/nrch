...
// if(UNICODE) strx=UnicodeToUTF8(strx)
// else strx= UTF8ToUnicode(strx)
...
/*****************
 ...
 e √© √® ·∫ª ·∫Ω ·∫π / E √â √à ·∫∫ ·∫º ·∫∏
 √™ ·∫ø ·ªÅ ·ªÉ ·ªÖ ·ªá / √ä ·∫æ ·ªÄ ·ªÇ ·ªÑ ·ªÜ

 i √≠ √¨ ·ªâ ƒ© ·ªã / I √ç √å ·ªà ƒ® ·ªä

 o √≥ √≤ ·ªè √µ ·ªç / O √ì √í ·ªé √ï ·ªå
 ∆° ·ªõ ·ªù ·ªü ·ª° ·ª£ / ∆  ·ªö ·ªú ·ªû ·ª  ·ª¢
 √¥ ·ªë ·ªì ·ªï ·ªó ·ªô / √î ·ªê ·ªí ·ªî ·ªñ ·ªò

 u √∫ √π ·ªß ≈© ·ª• / U √ö √ô ·ª¶ ≈® ·ª§
 ∆∞ ·ª© ·ª´ ·ª≠ ·ªØ ·ª± / ∆Ø ·ª® ·ª™ ·ª¨ ·ªÆ ·ª∞

 y √Ω ·ª≥ ·ª∑ ·ªπ ·ªµ / Y √ù ·ª≤ ·ª∂ ·ª∏ ·ª¥
***************/
function UnicodeToUTF8(str1)
{
  str1= str1.replace(/\u00E1/g,'√°');
  str1= str1.replace(/\u00C1/g,'√Å');
  str1= str1.replace(/\u00E0/g,'√ ');
  str1= str1.replace(/\u00C0/g,'√Ä');
  str1= str1.replace(/\u1EA3/g,'·∫£');
  str1= str1.replace(/\u1EA2/g,'·∫¢');
  str1= str1.replace(/\u00E3/g,'√£');
  str1= str1.replace(/\u00C3/g,'√É');
  str1= str1.replace(/\u1EA1/g,'·∫°');
  str1= str1.replace(/\u1EA0/g,'·∫ ');
  //· ¡
