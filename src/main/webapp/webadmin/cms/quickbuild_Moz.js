...
<INPUT name='QBCNTRL8' title='Upload Images' value='Upload Images' class=vdev onclick='doUploadFile(1)' type=button style='width:80'>\
<INPUT name='QBCNTRL9' title='Upload Files' value='Upload Files' class=vdev onclick='doUploadFile(2)' type=button style='width:80'>\
"
...
<INPUT name='QBCNTRL10' title='General options' value='"+M_OPTIONS+"' class=vdev onclick='doEditorOptions()' type=button style='width:50'>\
<INPUT name='QBCNTRL11' title='Help' value='"+M_HELP+"' class=vdev onclick='displayHelp()' type=button style='width:35'>\
"
}
else
{
