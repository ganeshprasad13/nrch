...
%>
 <%response.sendRedirect("http://"+request.getServerName()+"/works/webadmin/index.jsp?msg=Invalid session please login again."); 
 }else{%>
...
if ( sConnUrl.substr(0,1) != '/' && sConnUrl.indexOf( '://' ) < 0 )
	sConnUrl = window.location.href.replace( /browser.jsp.*$/, '' ) + sConnUrl ;
...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	<frameset cols="150,*" class="Frame" framespacing="3" bordercolor="#f1f1e3" frameborder="1">
		<frameset rows="50,*" framespacing="0">
			<frame src="frmresourcetype.jsp" scrolling="no" frameborder="0">
