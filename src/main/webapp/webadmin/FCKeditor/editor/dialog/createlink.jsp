...
String query;
query = "SELECT DSM_ID, DLC_LABEL, DSM_PATH FROM DBANK_SECTION_MANAGEMENT, DBANK_LANGUAGE_CONTENT ";
...
<td>
<select name="intLink" id="intLink" size="6" onChange="javascript:updateLink()" class="vdev" style="width:100%">
<%if(rslevel.size()!=0){
