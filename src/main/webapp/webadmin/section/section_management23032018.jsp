...
<%}%>
		...
		<div align="left" id="D1" style="display:none">
			<table width=750 align=center border=1 style="border-collapse: collapse" bordercolor="#111111" class="texts1">
				...
				<tr>
					<td align="right" width="50%">Label (&#2361;&#2367;&#2344;&#2381;&#2342;&#2368;)</td>
					<td width="50%"><input type="text" class="textboxh" name="label1"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<font class="tab"><a style="color:red;" href="javascript:showRTF(1);" class="tablink">English</a></font>&nbsp;&nbsp;<font class="tab"><a style="color:red;" href="javascript:showRTF(2);" class="tablink">&#2361;&#2367;&#2344;&#2381;&#2342;&#2368;</a></font>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<div id="rtf1" style="">
							<table style="font-size:12px;"><tr>
								<td align="center"><b>Description in English</b><br>
									<textarea name=description0 rows=10 cols=50>Coming soon</textarea>
								</td>
							</tr></table>
						</div></td>
				</tr>		
						...
						<div id="rtf2" style="display:none">
							<table style="font-size:12px;"><tr>
								<td align="center"><b>Description in &#2361;&#2367;&#2344;&#2381;&#2342;&#2368;</b><br>
									<textarea name=description1 rows=10 cols=50>Coming soon</textarea>
								</td>
							</tr></table>
						</div></td>
				</tr>
...
<%						}			// end of IF for htSectionIDs_valid.containsKey(dbBean.getcell(getinfo,0,i))
						if(dbBean.getcell(getinfo,4,i).equals("2")){%>
							<a style="color:red;font-size:11px;" href="section_direct.jsp?id=<%=dbBean.getcell(getinfo,0,i)%>" class="linkn"><!--<img src="../images/document_add.gif" alt="Create New Sub-section..." border="0">-->View Sub-section</a>&nbsp;&nbsp;&nbsp;
<%						}else{%>
