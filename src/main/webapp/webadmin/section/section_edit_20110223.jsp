...
query_info = query_info + request.getParameter("id")+" AND DSM_ID=DLC_DSM_ID order by DLC_LANG_ID";
...
query = query + " AND DSM_ID = DLC_DSM_ID and DSM_PARENT <> -1 and DSM_STATUS = 1 and DSM_ID IN ("+dbBean.getcell(getinfo,17,0)+")";
...
<%	if(strLanguageOption.equals("1") || strLanguageOption.equals("3")){%>
		<table><tr>
		<td align="center" style="font-size:12px;"><b>Description in &#2361;&#2367;&#2344;&#2381;&#2342;&#2368;</b><br>
