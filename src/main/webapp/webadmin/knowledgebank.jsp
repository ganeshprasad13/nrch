...
<title>Rwf video & document</title>
<style>
.main {
   width: 390px;
   padding: 100px;
...
table, td, th {
	...
	function validate()
{
	document.form1.action="KnowledgeBankAction.jsp?usr=<%=request.getParameter("usr")%>";
...
<form id="form1" name="addContract" ENCTYPE="multipart/form-data" action="KnowledgeBankAction.jsp" METHOD="POST" onsubmit="return CheckForm();">
<body bgcolor="#FFFAFA">
<div class="main">
...
<tr>
				...
				<td>
					<input type="radio" name="radio" value="1" checked="checked" onclick="validate(this.value)"/> Video 
...
<div width="350px" id="faq" style="display:none">
	...
	<center>
	<p><input type="button" onclick="validate()" value="Submit" name="B1"></p>
	</center>
