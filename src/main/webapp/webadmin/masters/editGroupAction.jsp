...
if(strID!=null && request.getParameter("edit")!=null){
		...
		strQuery = "UPDATE CMS_GROUPS SET CMSDEPT_NAME='"+strDept+"',CMSDEPT_DESC = '"+strDesc+"',CMSDEPT_CMSD_ID= '"+strDivision+"' WHERE CMSDEPT_ID="+strID+"";
		//out.print(strQuery);
...
%>
	...
	<% 
		response.sendRedirect("manageGroups.jsp?msg=Group%20Updated!");
}%>