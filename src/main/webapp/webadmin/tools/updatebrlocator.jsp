...
queryupdate = "Insert into branchdetails (BR_CODE, BR_NAME, BR_BUS_HR, SUN_BKG_Y_N, SUN_BUS_HR) VALUES  ('"+dbBean.getcell(vec,0,i)+"','"+dbBean.getcell(vec,1,i)+"','"+dbBean.getcell(vec,0,i)+"','"+dbBean.getcell(vec,0,i)+"','"+dbBean.getcell(vec,0,i)+"')";
