...
try {
	...
	while(i.hasNext()){
		...
		if (item.isFormField()) {
			...
			if (name.equals("tender1")){
				 tender1 = value.replaceAll("'","''");
			}
			if (name.equals("tender2")){
				 tender2 = value.replaceAll("'","''");
			}
			if (name.equals("tender3")){
				 tender3 = value.replaceAll("'","''");
			}
			if (name.equals("tender4")){
				 tender4 = value.replaceAll("'","''");
			}
			if (name.equals("tender5")){
				 tender5 = value.replaceAll("'","''");
			}
			if (name.equals("tender6")){
				 tender6 = value.replaceAll("'","''");
			}
			if (name.equals("tender7")){
				 tender7 = value.replaceAll("'","''");
			}
			if (name.equals("tender8")){
				 tender8 = value.replaceAll("'","''");
			}
			if (name.equals("tender9")){
				 tender9 = value.replaceAll("'","''");
			}
			if (name.equals("tender10")){
				 tender10 = value.replaceAll("'","''");
			}
