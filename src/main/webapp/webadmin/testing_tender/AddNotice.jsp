...
// - coursesweb.net
  ...
  if(re==1) {
   ...
   {  
	...
	var img1 = id2.value;
	var arr=img1.substring(0,img1.indexOf('.')-1);
	var iChars = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars.length; i++) {   
	...
	var arr2=img2.substring(0,img2.indexOf('.')-1);
	var iChars2 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars2.length; i++) {   
        if (arr2.indexOf(iChars2.charAt(i)) != -1||arr2.indexOf(' ')!=-1)    
        {    
          alert("Special characters and spaces are not allowed in file name");
	...
	var arr3=img3.substring(0,img3.indexOf('.')-1);
	var iChars3 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars3.length; i++) {   
        if (arr3.indexOf(iChars3.charAt(i)) != -1||arr3.indexOf(' ')!=-1)    
        {    
          alert("Special characters and spaces are not allowed in file name");
	...
	var arr4=img4.substring(0,img4.indexOf('.')-1);
	var iChars4 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars4.length; i++) {   
        if (arr4.indexOf(iChars4.charAt(i)) != -1||arr4.indexOf(' ')!=-1)    
        {    
          alert("Special characters and spaces are not allowed in file name");
	...
	var arr5=img5.substring(0,img5.indexOf('.')-1);
	var iChars5 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars5.length; i++) {   
        if (arr5.indexOf(iChars5.charAt(i)) != -1||arr5.indexOf(' ')!=-1)    
        {    
          alert("Special characters and spaces are not allowed in file name");
	...
	function showalert(){
		...
		var cat=document.getElementById("t_tender_cat").value;
		if(cat=='1'){
			
			alert("For supply Tenders,Tender cost should be zero.");
        ...
        <table width="50%" border="1" align="center" class="sample">
			...
			<tr>
			 ...
			 <tr>
                ...
                <td><select name="t_tender_cat" id="t_tender_cat" onchange="showalert()">
