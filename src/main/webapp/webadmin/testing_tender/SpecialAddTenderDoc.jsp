...
<form id="form1" name="AddTenderDocAction" action="SpecialAddTenderDocAction.jsp" METHOD="POST" ENCTYPE="multipart/form-data" onsubmit="return CheckForm();">
		...
		<tr>
            ...
            <tr>
                <td rowspan="2">Upload File (English) </td>
                <td nowrap="nowrap">(1)&nbsp;
				<input type="text" name="tender1" size="20">&nbsp; 
				<input type="file" name="FileUpload11" id="FileUpload11" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
           
            <tr>
                <td nowrap="nowrap">(2)&nbsp;
				<input type="text" name="tender2" size="20">&nbsp;
				<input type="file" name="FileUpload12" id="FileUpload12" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
            <tr>
                <td rowspan="2">&nbsp;</td>
                <td nowrap="nowrap">(3)&nbsp;
				<input type="text" name="tender3" size="20">&nbsp; 
				<input type="file" name="FileUpload1" id="FileUpload1" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
            <tr>
                <td nowrap="nowrap">(4)&nbsp;
				<input type="text" name="tender4" size="20">&nbsp;
				<input type="file" name="FileUpload13" id="FileUpload13" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr><tr>
                <td rowspan="2">&nbsp;</td>
                <td nowrap="nowrap">(5)&nbsp;
				<input type="text" name="tender5" size="20">&nbsp; 
				<input type="file" name="FileUpload1" id="FileUpload1" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
			<tr>
                <td nowrap="nowrap">(6)&nbsp;
				<input type="text" name="tender6" size="20">&nbsp;
				<input type="file" name="FileUpload14" id="FileUpload14" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
			<tr>
                <td rowspan="2">&nbsp;</td>
                <td nowrap="nowrap">(7)&nbsp;
				<input type="text" name="tender7" size="20">&nbsp; 
				<input type="file" name="FileUpload1" id="FileUpload1" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
			<tr>
                <td nowrap="nowrap">(8)&nbsp;
				<input type="text" name="tender8" size="20">&nbsp;
				<input type="file" name="FileUpload15" id="FileUpload15" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
			<tr>
                <td rowspan="2">&nbsp;</td>
                <td nowrap="nowrap">(9)&nbsp;
				<input type="text" name="tender9" size="20">&nbsp; 
				<input type="file" name="FileUpload1" id="FileUpload1" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
			<tr>
                <td nowrap="nowrap">(10) <input type="text" name="tender10" size="20">&nbsp;
				<input type="file" name="FileUpload16" id="FileUpload16" class="textbox" onchange="ChkfileExt(this);" size="1"/></td>
            </tr>
            <tr>
