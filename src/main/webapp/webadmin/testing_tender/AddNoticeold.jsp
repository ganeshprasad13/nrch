...
// - coursesweb.net
  ...
  if(re==1) {
   ...
   {  
	...
	var iChars = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars.length; i++) {   
        if (arr.indexOf(iChars.charAt(i)) != -1)    
        {    
	...
	var iChars2 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars2.length; i++) {   
        if (arr2.indexOf(iChars2.charAt(i)) != -1)    
        {    
          alert("Special characters are not allowed in file name");
	...
	var iChars3 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars3.length; i++) {   
        if (arr3.indexOf(iChars3.charAt(i)) != -1)    
        {    
          alert("Special characters are not allowed in file name");
	...
	var iChars4 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars4.length; i++) {   
        if (arr4.indexOf(iChars4.charAt(i)) != -1)    
        {    
          alert("Special characters are not allowed in file name");
	...
	var iChars5 = "!@#$%^&*()+=-[]\';,/{}|\"<>?";   
      for (var i = 0; i < iChars5.length; i++) {   
        if (arr5.indexOf(iChars5.charAt(i)) != -1)    
        {    
          alert("Special characters are not allowed in file name");
