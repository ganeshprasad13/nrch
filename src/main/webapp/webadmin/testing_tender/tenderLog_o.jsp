...
<form name="userLog" action="tenderLog.jsp" method="post" >
	<table width="80%" border="1" align="center" class="sample">
		...
		<tr>
			...
			<td> <input type="text" name="byDate" id="endDate" value="<%if(request.getParameter("endDate") != null){out.print(request.getParameter("endDate"));}%>"><script language="JavaScript">
                                            new tcal ({
                                                // form name
                                                'formname': 'userLog',
                                                 // input name
