...
<%
	...
	if(!id.equals("")){
		String strNotice = "SELECT 	DATE_FORMAT(T_BID_OPEN_DATE,'%d-%m-%Y'), DATE_FORMAT(T_BID_OPEN_DATE,'%H:%i'),DATE_FORMAT(T_DOC_START_DATE,'%d-%m-%Y'), DATE_FORMAT(T_DOC_START_DATE,'%H:%i'),DATE_FORMAT(T_DOC_END_DATE,'%d-%m-%Y'), DATE_FORMAT(T_DOC_END_DATE,'%H:%i'),DATE_FORMAT(T_BIDSUB_START_DATE,'%d-%m-%Y'), DATE_FORMAT(T_BIDSUB_START_DATE,'%H:%i'), DATE_FORMAT(T_BIDSUB_END_DATE,'%d-%m-%Y'), DATE_FORMAT(T_BIDSUB_END_DATE,'%H:%i') FROM CMS_NOTICE_MASTER_NEW WHERE T_ID="+id+"";
