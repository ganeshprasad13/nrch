   ...
   {  
     var testValue=testid.value;
      ...
      for (var i = 0; i < iChars.length; i++) {   
        ...
        {    
          alert(" Special characters like ' and %  are not allowed.");
...
<%if(Hname.equals("sr")){%>
	...
	if(fileName.lastIndexOf(".pdf")==-1 ){
		...
		id.value="";
		// added on 05 nov 2013 for IE bug
		id.parentNode.replaceChild(
		id.cloneNode(true), id);
	}
}
...
String strState = "";
strState = "SELECT StateID,StateName FROM cms_state_master ORDER BY StateName";
