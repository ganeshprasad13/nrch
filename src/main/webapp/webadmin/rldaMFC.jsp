...
document.form1.action='rldaMFC.jsp?ZONE_ID='+data;
...
String strDivId  = "-100";
if(request.getParameter("DIV_ID")!=null &&  !request.getParameter("DIV_ID").trim().equals("")){
	strDivId = request.getParameter("DIV_ID");
}

String strDiv = "";
strDiv="SELECT DISTINCT DIV_NAME FROM RLDA_STATIONS WHERE ZN_CODE =?";
System.out.print("hello2");
ps=cn.prepareStatement(strDiv);
ps.setString(1,strZoneId);
	...
	String rsGetDiv[][] = getResultSet(rs_new);
	System.out.print("hello3");

String strStation = "";

	
	strStation = "SELECT DISTINCT CMSSTN_NAME FROM RLDA_STATIONS WHERE ZN_CODE =?";
...
<body >
<p align="center"><span class="mgContentTitle">&nbsp;&nbsp;&nbsp;<b><font color="#FF0000" size="4">MFC sites details entry form &nbsp;</font></b>&nbsp;&nbsp;</span></p>
  ...
  <table width="800" border="1" cellspacing="1" align="center" class="sample" style="font-family:Tahoma; font-size:12px;">
     ...
     <tr>
			...
			<tr>
			 ...
			 <tr>
                <td width="46%" bgcolor="#DEDEEF">Division</td>
                <td width="52%" bgcolor="#DEDEEF"><select name="DIV_ID" id="DIV_ID"  >
				<option value=-1">--Select Division--</option>
				<%if(rsGetDiv.length>0){
						for(int i=0;i<rsGetDiv.length;i++){%>
							<option value="<%=rsGetDiv[i][0]%>" <%if(strDivId.equals(rsGetDiv[i][0])){%>selected<%}%>><%=rsGetDiv[i][0]%></option>
						<%	}
						}%>
		...
		<tr>
			...
			<tr >
                 ...
                 <td nowrap="nowrap" colspan="2" bgcolor="#DEDEEF"><input type="submit" name="sub" id="sub" formaction="rldasubmitMFC.jsp" /></td>
